...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Your account and app data are stored using Supabase, our backend service provider, with industry-standard security practices; this includes the chat photos, videos, and voice messages you send. Push notifications are delivered through Firebase Cloud Messaging (Google), which receives your device token for that purpose. While we take reasonable steps to protect your data, no method of storage or transmission is 100% secure.'**
  ...
  /// No description provided for @onboardingGiveTitle.
  ///
  /// In en, this message translates to:
  /// **'Give what you don\'t need'**
  String get onboardingGiveTitle;

  /// No description provided for @onboardingGiveBody.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @whatsNewMediaTitle.
  ///
  /// In en, this message translates to:
  /// **'Photos, videos & voice in chat'**
  String get whatsNewMediaTitle;

  /// No description provided for @whatsNewMediaBody.
  ///
  /// In en, this message translates to:
  /// **'Send pictures, video clips and voice messages right inside any chat.'**
  String get whatsNewMediaBody;

  /// No description provided for @whatsNewOfflineTitle.
  ///
  /// In en, this message translates to:
  /// **'Saved on your phone'**
  String get whatsNewOfflineTitle;

  /// No description provided for @whatsNewOfflineBody.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @whatsNewDonorsTitle.
  ///
  /// In en, this message translates to:
  /// **'Meet our donors'**
  String get whatsNewDonorsTitle;

  /// No description provided for @whatsNewDonorsBody.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @whatsNewFastTitle.
  ///
  /// In en, this message translates to:
  /// **'Opens instantly'**
  String get whatsNewFastTitle;

  /// No description provided for @whatsNewFastBody.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @clearChatAction.
  ///
  /// In en, this message translates to:
  /// **'Clear'**
  ...
  /// No description provided for @c153a.
  ///
  /// In en, this message translates to:
  /// **'New About screen with the app\'s purpose and full version history'**
  String get c153a;

  /// No description provided for @c153b.
  ///
  /// In en, this message translates to:
  /// **'Fixed replying from a notification getting stuck on loading'**
  String get c153b;

  /// No description provided for @c153c.
  ///
  /// In en, this message translates to:
