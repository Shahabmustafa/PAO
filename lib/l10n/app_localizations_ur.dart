...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get privacyDate => '26 ستمبر 2026';
  ...
  String get privacy1Body =>
      'ہم وہ معلومات جمع کرتے ہیں جو آپ براہِ راست فراہم کرتے ہیں، جیسے آپ کا نام، ای میل ایڈریس، پروفائل فوٹو، اور وہ فہرستیں، درخواستیں یا پیغامات جو آپ بناتے ہیں۔ اس میں وہ تصاویر، ویڈیوز اور وائس پیغامات شامل ہیں جو آپ چیٹ میں بھیجنے کا انتخاب کرتے ہیں؛ ان تک کیمرہ، فوٹو لائبریری یا مائیکروفون کے ذریعے صرف اسی وقت رسائی ہوتی ہے جب آپ یہ خصوصیات استعمال کریں۔ ہم ایپ کے استعمال سے پیدا ہونے والی معلومات بھی جمع کرتے ہیں، جیسے آپ کی پسندیدہ فہرست، محفوظ کردہ مقام/صوبہ، اپنی فہرستوں میں آپ کا دیا ہوا پک اپ ایڈریس، اور ایپ کی ترجیحات (تھیم، زبان)۔ اگر آپ کسی دوسرے صارف کی رپورٹ کرتے یا اسے بلاک کرتے ہیں تو ہم وہ رپورٹ (آپ کا منتخب کردہ سبب، آپ کی لکھی ہوئی تفصیل، وہ کس کے بارے میں ہے اور کب کی گئی) اور بلاک بھی محفوظ کرتے ہیں۔';
  ...
  String get privacy2Body =>
      'ہم آپ کی معلومات ایپ کی بنیادی خصوصیات چلانے کے لیے استعمال کرتے ہیں: آپ کا پروفائل دکھانا، فہرستوں اور درخواستوں کو ظاہر کرنا اور ملانا، صارفین کے درمیان چیٹ (متن، تصاویر، ویڈیوز اور وائس پیغامات) ممکن بنانا، آپ کی پسندیدہ فہرست برقرار رکھنا، اور آپ کی سیٹنگز یاد رکھنا۔ ہم رپورٹس کمیونٹی کو محفوظ رکھنے کے لیے استعمال کرتے ہیں: انہیں دیکھتے ہیں، اور جب کسی صارف کی پانچ مختلف افراد رپورٹ کر دیں تو اس کا اکاؤنٹ خودکار طور پر معطل کر دیا جاتا ہے۔ بلاک صرف اس لیے استعمال ہوتا ہے کہ بلاک کیا گیا شخص آپ کو پیغام نہ بھیج سکے۔';
  ...
  String get privacy4Body =>
      'ایپ کے معمول کے مطابق کچھ معلومات دیگر صارفین کو نظر آتی ہیں، جیسے آپ کی پوسٹ کی گئی فہرستوں پر آپ کا پروفائل نام، تصویر اور پک اپ ایڈریس، اور چیٹ کے ذریعے بھیجے گئے آپ کے پیغامات، تصاویر، ویڈیوز یا وائس پیغامات (چیٹ میڈیا نجی طور پر محفوظ ہوتا ہے اور اسے صرف آپ اور وہ شخص کھول سکتا ہے جسے آپ نے بھیجا)۔ ہم آپ کی ذاتی معلومات تیسرے فریق کو فروخت نہیں کرتے۔ رپورٹ صرف ہمیں نظر آتی ہے، اور جس کی آپ رپورٹ کرتے ہیں اسے نہیں بتایا جاتا کہ رپورٹ کس نے کی۔ بلاک بھی نجی ہے: جسے آپ بلاک کرتے ہیں اسے اطلاع نہیں ملتی، لیکن وہ آپ کو پیغام نہیں بھیج سکتا۔';
  ...
  String get privacy5Body =>
      'آپ کا اکاؤنٹ اور ایپ کا ڈیٹا ہمارے بیک اینڈ سروس فراہم کنندہ Supabase کے ذریعے، صنعتی معیار کے حفاظتی طریقوں کے ساتھ محفوظ کیا جاتا ہے؛ اس میں آپ کی بھیجی ہوئی چیٹ تصاویر، ویڈیوز اور وائس پیغامات شامل ہیں۔ پش نوٹیفکیشن Firebase Cloud Messaging (Google) کے ذریعے بھیجے جاتے ہیں، جو اس مقصد کے لیے آپ کے ڈیوائس ٹوکن کو وصول کرتا ہے۔ اگرچہ ہم آپ کے ڈیٹا کی حفاظت کے لیے معقول اقدامات کرتے ہیں، لیکن ذخیرے یا ترسیل کا کوئی بھی طریقہ 100% محفوظ نہیں ہوتا۔';
  ...
  String get privacy6Body =>
      'آپ سیٹنگز میں پروفائل میں ترمیم سے اپنا پروفائل کسی بھی وقت دیکھ اور اپ ڈیٹ کر سکتے ہیں۔ آپ سیٹنگز سے اپنا اکاؤنٹ حذف کرنے کی درخواست کر سکتے ہیں، جس سے آپ کا پروفائل، فہرستیں، پسندیدہ فہرست، آپ کا بھیجا ہوا چیٹ میڈیا اور متعلقہ ڈیٹا ہمارے سسٹمز سے مستقل طور پر ہٹا دیا جاتا ہے۔ چیٹ میں آپ گفتگو صاف کر سکتے ہیں (وہ صرف آپ کو نظر آنا بند ہوتی ہے، دوسرے شخص کے پاس اس کی کاپی رہتی ہے)، اور آپ کسی بھی وقت کسی صارف کی رپورٹ، بلاک یا ان بلاک کر سکتے ہیں۔';
  ...
  String get privacy7Body =>
      'ہم آپ کی معلومات اس وقت تک رکھتے ہیں جب تک آپ کا اکاؤنٹ فعال ہو یا ایپ کی خصوصیات فراہم کرنے کے لیے ضروری ہو۔ اکاؤنٹ حذف کرنے کے بعد آپ کا ذاتی ڈیٹا ہٹا دیا جاتا ہے، سوائے اس کے کہ قانون کے تحت اسے رکھنا لازمی ہو۔ آپ کی بھیجی گئی یا آپ کے بارے میں کی گئی رپورٹس اور بلاکس اکاؤنٹ کے ساتھ ہی حذف ہو جاتے ہیں۔';
  ...
  @override
  String get slideToCancel => 'منسوخ کرنے کے لیے بن دبائیں';
  ...
  String get holdToRecordVoice =>
      'وائس پیغام بہت مختصر ہے۔ مائیک دبائیں اور کم از کم 1 سیکنڈ بولیں۔';
  ...
  String get updateReadyMessage =>
      'نیا ورژن ڈاؤن لوڈ ہو گیا ہے۔ اپڈیٹ مکمل کرنے کے لیے ری اسٹارٹ کریں۔';

  @override
  String get restartToUpdate => 'ری اسٹارٹ';

  @override
  String get onboardingGiveTitle => 'جو ضرورت نہیں، دے دیں';

  @override
  String get onboardingGiveBody =>
      'اپنی غیر استعمال شدہ چیزیں تصاویر اور مقام کے ساتھ پوسٹ کریں تاکہ کوئی قریبی ضرورت مند ان سے فائدہ اٹھا سکے۔';

  @override
  String get onboardingFindTitle => 'جو چاہیے، مفت پائیں';

  @override
  String get onboardingFindBody =>
      'کیٹیگری، حالت اور شہر کے حساب سے تلاش کریں، پھر دینے والے کو درخواست بھیجیں۔';

  @override
  String get onboardingChatTitle => 'بات کریں، کام مکمل کریں';

  @override
  String get onboardingChatBody =>
      'تصاویر، ویڈیوز اور وائس میسج کے ساتھ بات کریں، پھر مل کر اپنی چیز لے لیں۔';

  @override
  String get whatsNewMediaTitle => 'چیٹ میں تصاویر، ویڈیو اور آواز';

  @override
  String get whatsNewMediaBody =>
      'کسی بھی چیٹ میں تصاویر، ویڈیو کلپس اور وائس میسج بھیجیں۔';

  @override
  String get whatsNewOfflineTitle => 'آپ کے فون میں محفوظ';

  @override
  String get whatsNewOfflineBody =>
      'جو میڈیا آپ کھولتے ہیں وہ آپ کے فون میں محفوظ ہو جاتا ہے، اس لیے فوراً کھلتا ہے اور انٹرنیٹ کے بغیر بھی چلتا ہے۔';

  @override
  String get whatsNewDonorsTitle => 'ہمارے ڈونرز سے ملیں';

  @override
  String get whatsNewDonorsBody =>
      'نیا ڈونرز ٹیب ان لوگوں کو سراہتا ہے جنہوں نے سب سے زیادہ دیا۔';

  @override
  String get onboardingCommunityTitle => 'ہماری کمیونٹی کا حصہ بنیں';

  @override
  String get onboardingCommunityBody =>
      'ہر دی گئی چیز ضائع ہونے سے بچتی ہے اور کسی کے کام آتی ہے۔ شروع کرنے کے لیے تیار ہیں؟';

  @override
  String get whatsNewFastTitle => 'فوراً کھلتی ہے';

  @override
  String get whatsNewFastBody =>
      'آپ کی فیڈ، درخواستیں اور وش لسٹ اب فون سے فوراً نظر آتی ہیں، پھر پس منظر میں اپ ڈیٹ ہو جاتی ہیں۔';

  @override
  String get clearChat => 'چیٹ صاف کریں';
  ...
  String get clearChatConfirm =>
      'اس چیٹ کے تمام پیغامات آپ کے لیے ہٹا دیے جائیں گے۔ دوسرے شخص کے پاس ان کی کاپی رہے گی۔';

  @override
  String get chatCleared => 'چیٹ صاف کر دی گئی';

  @override
  String get reportUser => 'صارف کی رپورٹ کریں';

  @override
  String get blockUser => 'صارف کو بلاک کریں';

  @override
  String get unblockUser => 'ان بلاک';

  @override
  String get blockUserConfirm =>
      'وہ آپ کو پیغام نہیں بھیج سکے گا۔ آپ کسی بھی وقت ان بلاک کر سکتے ہیں۔';

  @override
  String get userBlocked => 'صارف بلاک ہو گیا';

  @override
  String get userUnblocked => 'صارف ان بلاک ہو گیا';

  @override
  String get youBlockedThisUser => 'آپ نے اس صارف کو بلاک کیا ہوا ہے۔';

  @override
  String get reportUserSubtitle => 'آپ اس صارف کی رپورٹ کیوں کر رہے ہیں؟';

  @override
  String get reportReasonSpam => 'سپیم';

  @override
  String get reportReasonHarassment => 'ہراسانی یا بدسلوکی';

  @override
  String get reportReasonScam => 'دھوکہ یا فراڈ';
  ...
  @override
  String get reportDetailsHint => 'تفصیل لکھیں (اختیاری)';

  @override
  String get reportSent => 'شکریہ، آپ کی رپورٹ بھیج دی گئی۔';
  ...
  @override
  String get c153a =>
      'نئی ایپ کے بارے میں اسکرین: ایپ کا مقصد اور مکمل ورژن کی تاریخ';

  @override
  String get c153b =>
      'نوٹیفکیشن سے جواب دینے پر لوڈنگ میں پھنس جانے کا مسئلہ حل کر دیا گیا';
